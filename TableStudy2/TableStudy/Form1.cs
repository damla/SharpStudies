        ...
        private void uPDATEToolStripMenuItem_Click(object sender, EventArgs e)
        {
            /*  groupBox1.Visible = true; // update'e tikladigimiz gibi groupBox1 gorunur olucak.
              ...
              index = lvInfo.SelectedIndices[0]; // indexi update edilene kadar -1 tuttuk. Edilince de secilen ilk itemin
                                                 // indexine esitledik.
          */
            Form2 f = new Form2(lvInfo, lvInfo.SelectedIndices[0]); //secilen index eger 1 den fazlaysa sadece ilkinii updatelemek icin 0.indexten baslayarak constructorda onu aldik.
            f.ShowDialog();
        }
 ...
 */
/*
 * Lecture 9'da ne yaptik?
 * Update kismini form2'ye tasidik.
 * secilen index eger 1 den fazlaysa sadece ilkinii updatelemek icin 0.indexten baslayarak constructorda onu aldik.
 * Update buttonunda degisiiklik yok.
 * login kismini kaldirdik.
 * form2'de devam!
 */
